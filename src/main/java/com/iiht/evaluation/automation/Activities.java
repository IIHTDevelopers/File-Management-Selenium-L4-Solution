...
public class Activities {
    ...
    public static boolean click_download_option(WebDriver driver, String example_name) {
    ...
    public static boolean click_upload_option(WebDriver driver, String example_name) {
        String example_name_link_xpath = locators.herokuapp_upload_download_element.get("example_name_link").replace("$(example_name)", example_name);
